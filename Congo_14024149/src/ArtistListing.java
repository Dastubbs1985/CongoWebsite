 ...
 *
 *  Servlet created and used for the printing of sets of albums
 *  belonging to a specific artist within the database.
 *
...
@WebServlet("/artist")
public class ArtistListing extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		ArrayList<AlbumBean> albums = Cconnect.getArtist(artist);
...
//		Output on the screen
		...
		if (albums.isEmpty()) {
			out.println("<h3>No albums for that artist.....</h3>");
